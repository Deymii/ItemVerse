 ...
 * @author HP
 */
public class others_rent extends javax.swing.JFrame {
    Connection con;
    Statement st;
    ResultSet rs;
    ...
    public void conn(){
        try {
            ...
            ta.setText("\nRented item\nTitle: " + rs.getString("item_title") +
                        ...
                        "\nThe Price: " + rs.getString("item_price") +
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/rent.png"))); // NOI18N
        jLabel1.setText("Available Rented Items");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(others_rent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new others_rent().setVisible(true);
            }
        });
    }
