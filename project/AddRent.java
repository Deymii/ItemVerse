...
public class AddRent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add New Rented Item");
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        try{
            ...
            rs.updateInt("Item_price",Integer.parseInt(t3.getText()));
            rs.updateString("item_description",ta.getText());
            rs.insertRow();
            JOptionPane.showMessageDialog(null, "rented Item submited");
            Home myf = new Home();
            myf.setVisible(true);
